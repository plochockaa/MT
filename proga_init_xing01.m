...
function [intsctdistside,intsctysno,intsctdist] = ...
         proga_init_xing01(N,Nsegments,site,siten,segm,seedside,sidenode,xseed,L,gamma,intsctdistside,intsctysno,intsctdist,intsctinfty)
    ...
    for jj = 1:length(tocheckside),      % going through all the cell sides except the one that MT starts at
     ...
     tocheckMTarray = circshift([1:N]',-siten)'; tocheckMTarray = tocheckMTarray(1:end-1); % the array of which MTs to check xing with 
